    ...
    return (
      ...
      {user ? (
        <>
          ...
          <p>Username sample: {user.username}</p>
          ...
          )}
          {
            user.businessInfo.businessLogo && (
                ...
                <h4>Business Logo:</h4>
                <img
                  src={user.businessInfo.businessLogo}  // If base64 encoded, this should display correctly
                  alt="Profile"
                  style={{ width: '150px', height: '150px', borderRadius: '50%' }}  // Style the profile picture
                />
              </div>
          ...
          }
          {
            user.businessInfo.bannerImage && (
                ...
                <img
                  src={user.businessInfo.bannerImage}  // If base64 encoded, this should display correctly
                  alt="Profile"
                  style={{ width: '150px', height: '150px', borderRadius: '50%' }}  // Style the profile picture
                />
              </div>
